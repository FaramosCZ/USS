...
TODO:
* Download the SocketIO JS library and distribute it alongside te app, so it can work even
...
* Client should show "generating" progress bar, while waiting on sudoku to be generated by
  server
